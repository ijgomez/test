...
public class JVMMBeanDataDisplay extends MBeanDataDisplay {
   ...
   @Override
   StringBuffer writeAttribute(StringBuffer buffer,  ObjectName mbean, MBeanAttributeInfo info, Object value) {
       if (THREAD_MXBEAN_NAME.equals(mbean) && 
           ...
           buffer.append("# ").append("AllThreadInfo").append("\\n");
           return dataDisplay.write(buffer,"AllThreadInfo", threadInfos);
       } else {
           // default display.
           return super.writeAttribute(buffer,mbean,info,value);
       }
   }
}
