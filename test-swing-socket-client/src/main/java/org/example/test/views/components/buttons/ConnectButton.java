...
public class ConnectButton extends JButton implements ActionListener, ApplicationObserver {
	...
	private void initComponents() {
		super.setText(resourceBundle.getString("button.connect.text"));
		super.setToolTipText(resourceBundle.getString("button.connect.tooltip"));
	...
	public void actionPerformed(ActionEvent e) {
		this.observable.notify(new ConnectEvent());
	}
