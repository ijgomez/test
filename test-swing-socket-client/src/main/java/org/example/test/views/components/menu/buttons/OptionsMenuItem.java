...
public class OptionsMenuItem extends JMenuItem implements ApplicationObserver {
	...
	private void initComponents() {
		super.setText(resourceBundle.getString("menu.button.options.text"));
		super.setCursor(new Cursor(Cursor.HAND_CURSOR));
		super.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				observable.notify(new OptionsEvent());
			}
		});
	}
