...
//---------------------Nuevo Campo----------------------
	    ...
	    //Da un error de Loader, por lo que hemos empleado belongsTo y hasMany 
	    /*associations:[
	                  {type: 'hasOne', model: 'Cliente', primaryKey: 'id', foreignKey: 'pedido_id', name: 'cliente'}, //getCliente()
	                  {type: 'hasMany', model: 'Producto', primaryKey: 'id', foreignKey: 'pedido_id', name: 'productos'} //getProductos()
	    ],*/
	    belongsTo: [
